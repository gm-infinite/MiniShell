...
PIPES_SRC = pipes.c count_pipes.c split_by_pipes.c execute_pipe_command.c execute_pipe_child.c execute_pipe_child_utils.c pipes_utils.c pipe_child_utils.c
