...
EXECUTE_SRC = execute.c exec_utils.c signal.c exec_single.c exec_parentheses.c exec_dispatch.c exec_arg_process_utils.c pipe_management.c arg_utils.c path_utils.c exec_validation.c pipeline_utils.c heredoc_utils.c pipeline_process_utils.c pipeline_child_utils.c exec_arg_utils.c exec_wildcard_utils.c exec_wildcard_expand_utils.c exec_paren_utils.c
