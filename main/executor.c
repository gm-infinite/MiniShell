...
/*   Updated: 2025/07/14 17:03:20 by emgenc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
** ============================================================================
** COMMAND EXECUTION ENGINE - CORE EXECUTION ORCHESTRATOR
** ============================================================================
*/
 ...
 * 
 * This function implements the standard shell executable resolution algorithm,
 * mimicking the behavior of POSIX shells when searching for commands to execute.
 * It handles both absolute/relative paths and PATH-based command resolution.
 * 
 * RESOLUTION ALGORITHM:
 * 1. ABSOLUTE/RELATIVE PATH DETECTION: If command contains '/', treat as path
 *    - Check if file exists and is accessible
 *    - Return duplicated path if valid, NULL if not found
 * 
...
/*
** ============================================================================
** REDIRECTION DETECTION AND COMMAND ROUTING
** ============================================================================
*/
...
int	execute_pipeline_with_redirections(t_split split, t_shell *shell)
{
	...
	// PHASE 6: Child process synchronization
	...
	// PHASE 7: Resource cleanup and return
